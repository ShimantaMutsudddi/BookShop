...
import static com.example.bookshop.R.id.nav_profile_ID;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        navProfileImage=(CircleImageView) navView.findViewById(R.id.nav_profile_ID);
        NavProfileUserName=(TextView) navView.findViewById(R.id.user_full_nameId);
